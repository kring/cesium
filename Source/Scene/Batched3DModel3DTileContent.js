define([
    ...
    function getFragmentShaderCallback(content) {
        return function(fs) {
            ...
            var batchTableCallback = batchTable.getFragmentShaderCallback(true, diffuseUniformName);
            if (defined(batchTableCallback)) {
    ...
    function initialize(content, arrayBuffer, byteOffset) {
        ...
        content._model = new Model({
            ...
            fragmentShaderLoaded : getFragmentShaderCallback(contentthis),
            uniformMapLoaded : getUniformMapCallback(content),
            pickVertexShaderLoaded : getPickVertexShaderCallback(content),
            pickFragmentShaderLoaded : getPickFragmentShaderCallback(content),
            pickUniformMapLoaded : getPickUniformMapCallback(content),
